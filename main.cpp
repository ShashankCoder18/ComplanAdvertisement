...

{
    ...
    glBegin(GL_POLYGON);			//road middle
...

{
	...
	glBegin(GL_POLYGON);			//book1 in rack
	...
	glBegin(GL_POLYGON);			//book2 in rack
	...
	glBegin(GL_POLYGON);			//book3 in rack
...

{
    ...
    glBegin(GL_POLYGON);			//tution top 3D
	...
	glBegin(GL_POLYGON);			//school top 3D
	...
	glBegin(GL_POLYGON);			//school side 3D
	...
	glBegin(GL_POLYGON);			//Home Side 3D
    ...
    glBegin(GL_POLYGON);			//Home top 3D
	...
	glBegin(GL_POLYGON);			//home top 3DD
...
static void Mykey(unsigned char key, int x, int y)
{
	...
	glBegin(GL_POLYGON);			//inner tv

	glColor3f(1.0f, 1.0f, 1.0f);

	glVertex3f(-47, 31.5, 0);

	glVertex3f(-47, 43.6, 0);

	glVertex3f(-31, 43.6, 0);

	glVertex3f(-31, 31.5, 0);
	...
	bitmap_output(-20, 32, "YUMMY !", GLUT_BITMAP_HELVETICA_18);

	bitmap_output(-43, 37.5, "HORLICKS", GLUT_BITMAP_TIMES_ROMAN_24);
...

{
	...
	bitmap_output(-3, 25, "UVCE", GLUT_BITMAP_TIMES_ROMAN_24);
...

{
	...
	glClearAccum(0.0,0.0,0.69,1);

	bitmap_output(-26, 40, "UNIVERSITY OF VISVESVARAYA COLLEGE OF ENGINEERING", GLUT_BITMAP_TIMES_ROMAN_24);

	bitmap_output(-15, 30, "COMPUTER SCIENCE AND ENGINEERING", GLUT_BITMAP_HELVETICA_18);

   	bitmap_output(-12, 20, "COMPUTER GRAPHICS PROJECT", GLUT_BITMAP_HELVETICA_18);
	...
	bitmap_output(-13, -25, "Rakshith J           17GAEC9053", GLUT_BITMAP_HELVETICA_18);

	bitmap_output(-13, -30, "Sumant S            17GAEC9060", GLUT_BITMAP_HELVETICA_18);
